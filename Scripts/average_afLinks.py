...
txt_file_path = 'C:\\Users\\phili\\OneDrive - Universitaet Duisburg-Essen\\Bachelorarbeit\\Algo\\JSON\\avgAFLinks.txt'
...
for entry in data:
    ...
    if isinstance(entry, list) and len(entry) > 0:
        ...
        # Nur weiterverarbeiten, wenn mindestens ein Affiliate-Link vorhanden ist
